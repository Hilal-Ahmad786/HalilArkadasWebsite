  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="bg-white py-6 border-b border-gray-100">
          <div className="container">
            <p className="text-center text-gray-600 text-sm md:text-base max-w-3xl mx-auto">
              Pert kaydı bulunan aracınızı beklemeye gerek yok; sigorta ve noter süreçlerinde de yanınızda olan{' '}
              <a
              ...
              profesyonel ekibimizden hemen teklif alın.
            </p>
          </div>
        </section>
        ...
        <DamageAssessmentGuide serviceType="pert" />

        {/* 4. SERVICE-SPECIFIC: Real Price Examples */}
        <PriceExamplesShowcase serviceType="pert" />

        {/* 5. Vehicle Types Accepted */}
        <VehicleTypesAccepted serviceType="pert" />

        {/* 6. SERVICE-SPECIFIC: Common Customer Scenarios */}
        <ServiceScenariosGrid serviceType="pert" />
        ...
        <FAQAccordion
          faqs={service.faqs}
          title="Pert Araç Alımı Hakkında SSS"
