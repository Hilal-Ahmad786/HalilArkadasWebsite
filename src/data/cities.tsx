...
export const cities: Record<string, City> = {
  'istanbul': {
    ...
    metaDescription: 'İstanbul\'da kazalı, hasarlı, pert ve hurda araç alımı. Avrupa ve Anadolu yakası hizmet. 2 saat içinde teklif. 0 552 567 71 64',
    keywords: [
  ...
  'ankara': {
    ...
    metaDescription: 'Ankara\'da kazalı, hasarlı, pert ve hurda araç alımı. Çankaya, Keçiören, Yenimahalle hizmet. 1 saat içinde teklif. 0 552 567 71 64',
    keywords: [
  ...
  'izmir': {
    ...
    metaDescription: 'İzmir\'de kazalı, hasarlı, pert ve hurda araç alımı. Karşıyaka, Bornova, Konak hizmet. 1 saat içinde teklif. 0 552 567 71 64',
    keywords: [
  ...
  'bursa': {
    ...
    metaDescription: 'Bursa\'da kazalı, hasarlı, pert ve hurda araç alımı. Osmangazi, Nilüfer, Yıldırım hizmet. 1 saat içinde teklif. 0 552 567 71 64',
    keywords: [
  ...
  'antalya': {
    ...
    metaDescription: 'Antalya\'da kazalı, hasarlı, pert ve hurda araç alımı. Muratpaşa, Kepez, Konyaaltı hizmet. 1 saat içinde teklif. 0 552 567 71 64',
    keywords: [
